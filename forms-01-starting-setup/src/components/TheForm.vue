<template>
  <form @submit.prevent="onSubmit">
    ...
    <div class="form-control">
      ...
      <select id="referrer" name="referrer" v-model="selectedValue">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-video" name="how" type="radio" value="video" v-model="radiobutton" />
        <label for="how-video">Video Courses</label>
      </div>
      <div>
        <input id="how-blogs" name="how" type="radio" value="blogs" v-model="radiobutton" />
        <label for="how-blogs">Blogs</label>
      </div>
      <div>
        <input id="how-other" name="how" type="radio" value="other" v-model="radiobutton" />
    ...
    <div class="form-control">
      <input type="checkbox" id="illia" name="illia" v-model="illia">
      <label for="illia">Agree of terms of use?</label>
    </div>
